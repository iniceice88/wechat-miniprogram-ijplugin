...
object ComponentFilesCreator {
  ...
  fun createWechatComponentFiles(
    ...
    val jsComponentTemplate = fileTemplateManager.getInternalTemplate(jsFileTemplateName)
    FileTemplateUtil.createFromTemplate(jsComponentTemplate, fileName, fileTemplateDefaultProps, psiDirectory)
    val jsonComponentTemplate = fileTemplateManager.getInternalTemplate(jsonFileTemplateName)
    FileTemplateUtil.createFromTemplate(jsonComponentTemplate, fileName, fileTemplateDefaultProps, psiDirectory)
