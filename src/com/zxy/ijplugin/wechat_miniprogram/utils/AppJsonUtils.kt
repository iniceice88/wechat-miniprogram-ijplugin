...
object AppJsonUtils {
  ...
  /**
   * 获取app.json中组册的所有全局组件
   */
  fun getUsingComponentItems(project: Project): Sequence<JsonProperty> {
    return findUsingComponentsValue(project)?.propertyList?.asSequence() ?: emptySequence()
  }
