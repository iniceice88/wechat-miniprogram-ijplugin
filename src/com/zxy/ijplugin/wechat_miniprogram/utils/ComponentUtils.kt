...
import com.zxy.ijplugin.wechat_miniprogram.extensions.isQQFileType
import com.zxy.ijplugin.wechat_miniprogram.extensions.isWxFileType
...
fun isComponentFile(psiFile: PsiFile): Boolean {
  return psiFile is JsonFile || psiFile.project.let {
    ...
    (it == MiniProgramType.QQ && (psiFile.isQQFileType()))
      || psiFile.isWxFileType()
  }
}
