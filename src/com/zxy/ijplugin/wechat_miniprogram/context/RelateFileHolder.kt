...
abstract class RelateFileHolder {
  ...
  companion object {
    val MARKUP by lazy { QQCompatibleRelateFileHolder(QMLFileType.INSTANCE, WXMLFileType.INSTANCE) }
    val SCRIPT by lazy { MultiFileTypeFileHolder(JavaScriptFileType, TypeScriptFileType) }
    val STYLE by lazy { QQCompatibleRelateFileHolder(QSSFileType.INSTANCE, WXSSFileType.INSTANCE) }
    val JSON by lazy { SingleFileTypeFileHolder(JsonFileType.INSTANCE) }

    val INSTANCES by lazy { arrayOf(MARKUP, SCRIPT, STYLE, JSON) }
