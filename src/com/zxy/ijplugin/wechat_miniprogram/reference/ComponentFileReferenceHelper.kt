...
/**
 * 提供组件文件引用根目录
 * 很多小程序项目代码根目录通过project.config.json的miniprogramRoot设置，一般在miniprogram下面
 * 这里把miniprogram加到根目录列表中。这样json中组件文件引用可以从miniprogram开始
 */
class ComponentFileReferenceHelper : PsiFileReferenceHelper() {
